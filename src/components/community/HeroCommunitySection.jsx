    ...
    <>
      <div className="bg-herobg w-10/12 mx-auto rounded-xl border p-4 grid md:grid-cols-12 sm:grid-cols-1 font-nunito">
        <div className="col-span-4 pl-10 place-self-center">
          <h1 className="font-black  text-purple-600 text-4xl leading-10 mb-5">An online community <br/> for entrepreneurial <br/> minded teachers<br/> to newtork, learn and share. </h1>
