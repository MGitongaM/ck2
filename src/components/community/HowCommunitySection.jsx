  ...
  return (
    ...
    <div className="w-10/12 mx-auto">
        <div className="flex justify-between w-4/5 mx-auto my-20 font-nunito">
            <div><img src="/src/assets/dash-rounded.svg" alt="dash-roundded-image" className="object-contain  h-auto w-24"/></div>
            <div><h2 className="font-meduim text-2xl text-purple-700 text-center">How it works</h2></div>
            <div><img src="/src/assets/video-camera.svg" alt="video-camera-image" className="object-contain  h-auto w-14"/></div>
        </div>
        <div className="grid grid-cols-2 gap-10 w-4/5 mx-auto font-nunito">
            <div className="border border-gray-200 rounded-lg p-4 text-start">
                <img src="/src/assets/content.svg" alt="content-image" className="object-cover  h-auto w-4/5 mx-auto"/>
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-start">
                <img src="/src/assets/resources.svg" alt="resource-image" className="object-cover  h-auto w-4/5 mx-auto"/>
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-start">
                <img src="/src/assets/events.svg" alt="events-image" className="object-cover  h-auto w-4/5 mx-auto"/>
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-start">
                <img src="/src/assets/networking.svg" alt="networking-image" className="object-cover  h-auto w-4/5 mx-auto"/>
